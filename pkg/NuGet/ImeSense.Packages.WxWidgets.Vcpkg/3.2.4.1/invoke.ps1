...
Function Invoke-Pack {
    ...
    Move-Item -Path "$Output/ImeSense.Packages.WxWidgets.Vcpkg.symbols.3.2.4.1.nupkg" -Destination "$Output/ImeSense.Packages.WxWidgets.Vcpkg.3.2.4.1.symbols.nupkg"
}
