...
function Invoke-Pack {
    nuget pack $PSScriptRoot\ImeSense.Packages.Sdl.Symbols.nuspec -OutputDirectory $Output
    nuget pack $PSScriptRoot\ImeSense.Packages.Sdl.Symbols.win-x86.nuspec -OutputDirectory $Output
    nuget pack $PSScriptRoot\ImeSense.Packages.Sdl.Symbols.win-x64.nuspec -OutputDirectory $Output
    nuget pack $PSScriptRoot\ImeSense.Packages.Sdl.Symbols.win-arm.nuspec -OutputDirectory $Output
    nuget pack $PSScriptRoot\ImeSense.Packages.Sdl.Symbols.win-arm64.nuspec -OutputDirectory $Output

    nuget pack $PSScriptRoot\ImeSense.Packages.Sdl.Runtimes.nuspec -OutputDirectory $Output
    nuget pack $PSScriptRoot\ImeSense.Packages.Sdl.Runtimes.win-x86.nuspec -OutputDirectory $Output
    nuget pack $PSScriptRoot\ImeSense.Packages.Sdl.Runtimes.win-x64.nuspec -OutputDirectory $Output
    nuget pack $PSScriptRoot\ImeSense.Packages.Sdl.Runtimes.win-arm.nuspec -OutputDirectory $Output
    nuget pack $PSScriptRoot\ImeSense.Packages.Sdl.Runtimes.win-arm64.nuspec -OutputDirectory $Output
