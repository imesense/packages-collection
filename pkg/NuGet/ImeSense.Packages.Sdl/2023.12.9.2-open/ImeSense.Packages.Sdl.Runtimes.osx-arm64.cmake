...
target_link_libraries(${PROJECT_NAME} PRIVATE libSDL3.1.0.0.dylib)

add_custom_command(TARGET ${PROJECT_NAME}
    POST_BUILD
    COMMAND ${CMAKE_COMMAND} -E copy_if_different ${SDL_RUNTIME_PATH}/libSDL3.1.0.0.dylib ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/
)
execute_process(
    COMMAND ln -s ln -s libSDL3.1.0.0.dylib libSDL3.dylib
