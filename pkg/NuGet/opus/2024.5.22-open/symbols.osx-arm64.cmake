...
set(OPUS_RUNTIME_ID "osx-arm64")
set(OPUS_RUNTIME_PATH "${OPUS_ROOT_PATH}/runtimes/${OPUS_RUNTIME_ID}/native/$(OPUS_CONFIG)/")

add_custom_command(TARGET ${PROJECT_NAME}
    POST_BUILD
    COMMAND ${CMAKE_COMMAND} -E copy_directory ${OPUS_RUNTIME_PATH}/libopus.0.10.1.dylib.dSYM ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/libopus.0.10.1.dylib.dSYM
)
