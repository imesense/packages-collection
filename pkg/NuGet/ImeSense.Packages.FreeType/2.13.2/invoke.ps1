$Source      = "https://gitlab.freedesktop.org/freetype/freetype.git"
$Branch      = "VER-2-13-2"
$Commit      = "920c5502cc3ddda88f6c7d85ee834ac611bb11cc"
$Destination = "dep/freetype/freetype/$Branch"
...
function Invoke-Pack {
    nuget pack $PSScriptRoot\ImeSense.Packages.FreeType.nuspec -OutputDirectory $Output
}
