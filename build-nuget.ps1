...
. .\build.ps1 -Type NuGet -Name ImeSense.Packages.FreeType        -Version 2.13.2
...
. .\build.ps1 -Type NuGet -Name ImeSense.Packages.FreeImage.WinMerge -Version 2023.8.19-open
. .\build.ps1 -Type NuGet -Name ImeSense.Packages.FreeType           -Version 2023.12.7-open
